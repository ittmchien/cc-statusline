...
#   Boolean keys (remote, folder, git, worktree, funny, jokeapi, model,
#     effort, context, turn, session, today, rolling, ratelimits, tokens,
#     bars): no value flips it, or pass on/off explicitly.
